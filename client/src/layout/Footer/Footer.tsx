            ...
            <div className={styles.footerPrimary}>
                <div className={styles.footerCenter}>
                    <div className={styles.footerCol}>
                        ...
                        <AnimatedLink href="/menu" isWhite className={styles.footerColItem}>Restaurant
                            Menu</AnimatedLink>
                    ...
                    <div className={styles.footerCol}>
                        ...
                        {props.roomNames.map(room => (
                            <AnimatedLink key={room.id} href={`rooms/${room.id}`} isWhite
                    ...
                    <div className={styles.footerCol}>
                        ...
                        <AnimatedLink href="https://www.facebook.com" isWhite className={styles.footerColItem}><Facebook
                            className={styles.socialIcon}/> Facebook</AnimatedLink>
                        <AnimatedLink href="https://www.twitter.com" isWhite className={styles.footerColItem}><Twitter
                            className={styles.socialIcon}/> Twitter</AnimatedLink>
                        <AnimatedLink href="https://www.instagram.com" isWhite
                                      className={styles.footerColItem}><Instagram
                            className={styles.socialIcon}/> Instagram</AnimatedLink>
                    </div>
                    <div className={styles.footerCol}>
